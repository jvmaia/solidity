...
.. warning::
  ...
  It is a compile-time type checks, and can be circumvented doing invalid explicit conversions
  between contract types, because the compiler can verify that the type of the contract does
  not do stage-changing operations, but it cannot check that the contract that will be called
